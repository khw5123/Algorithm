...
li = [list(map(str, input())) for _ in range(n_size)]
name, price = {}, {('A','A'):10, ('A','B'):8, ('A','C'):7, ('A','D'):5, ('A','F'):1, ('B','A'):8, ('B','B'):6, ('B','C'):4, ('B','D'):3, ('B','F'):1, ('C','A'):7, ('C','B'):4, ('C','C'):3, ('C','D'):2, ('C','F'):1, ('D','A'):5, ('D','B'):3, ('D','C'):2, ('D','D'):2, ('D','F'):1, ('F','A'):1, ('F','B'):1, ('F','C'):1, ('F','D'):1, ('F','F'):0}
    ...
    for j in range(m_size):
        if (i+j) % 2 == 0:
            ...
            for dx, dy in [(-1, 0), (1, 0), (0, -1), (0, 1)]:
                nx, ny = i+dx, j+dy
                if 0 <= nx < n_size and 0 <= ny < m_size:
